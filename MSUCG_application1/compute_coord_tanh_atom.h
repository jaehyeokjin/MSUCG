...
ComputeStyle(coord_tanh/atom,ComputeCoordTanhAtom)

#else

#ifndef LMP_COMPUTE_COORD_TANH_ATOM_H
#define LMP_COMPUTE_COORD_TANH_ATOM_H

#include "compute.h"

namespace LAMMPS_NS {

class ComputeCoordTanhAtom : public Compute {
 public:
  ComputeCoordTanhAtom(class LAMMPS *, int, char **);
  ~ComputeCoordTanhAtom();
  void init();
